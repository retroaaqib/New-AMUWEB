 ...
 * @author CC-005
 */
public class researchAddDao {
    public static String researchAdd(qualifAddBean qualAdd)
    {
    Connection con = DBConnection.createConnection();
        ...
        try {
            ...
            if (rs.next()) {
                ...
                rs.beforeFirst();
                sql = "insert into empQualif (pid,eduLevel,course,subjects,board,passoutYr,ipAddress,updated_at) values(?,?,?,?,?,?,?,NOW())";
                try {
                    ...
                    ps1.setString(6, passout);
                    ps1.setString(7, ipAddress);
                    i = ps1.executeUpdate();
                    ps1.close();
                    if (i > 0) {
