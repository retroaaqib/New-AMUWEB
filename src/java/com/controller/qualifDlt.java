...
import com.dao.qualifDltDao;

/**
 *
 * @author Aaqib Khan
 */
public class qualifDlt extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       qualifAddBean qualDlt = new qualifAddBean();
       qualDlt.setId(id);
       String ipAddr = "";
        if (request != null) {
        ...
        qualDlt.setIpAddress(ipAddr);
        qualDlt.setPid(pid);
        String qualifDlt = qualifDltDao.qualifDlt(qualDlt);
        switch (qualifDlt) {
            case "success":
                err = "Qualification has been Successfully Deleted!";
