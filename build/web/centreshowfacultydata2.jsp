...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en" class="ie ie9"> <!--<![endif]-->
    <head>
        ...
        <title>Aligarh Muslim University || Centres</title>
            ...
            <div class="content_wrapper">
                <div class="page_title_block">
                    <div class="container">
                        ...
                        <div class="breadcrumbs"><a href="index.jsp">Home</a><a href="#">Academics</a><a href="allcentres.jsp">Centres</a><a href="amucentre.jsp?did=<%=did%>"><%=dname%></a><a href="centrefacultylist.jsp?did=<%=did%>">Staff Members</a><span><%=rs.getString(3)%> <%=rs.getString(4)%> /&nbsp; <%=desig%></span></div>
                    </div>
                </div>        
                <div class="container">
                                    ...
                                    <div class="contentarea">
                                        <div class="row-fluid">
                                            <div class="span12 module_cont module_text_area module_small_padding">	  
                                                <div class="bg_title"><h4 class="headInModule"><%=dname%></h4></div>											
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="tab-content">
                                                                    <div id="home" class="tab-pane fade in active">
                                                                        ...
                                                                        <div class="row-fluid">
                                                                            <p style="font-weight: bolder;font-style: oblique; font-size: larger">Thrust</p>  
                                                                            <%=thrust%>
                                                                        </div>
                                                                        ...
                                                                        %>
                                                                        <div class="row-fluid">
                                                                            <p style="font-weight: bolder;font-style: oblique; font-size: larger">Profile</p><hr>
                                                                            <%=profile%>
                                                                        </div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12 module_cont module_text_area">
                                                <div class="bg_title"><h4 class="headInModule">Edit Profile</h4></div>


                                                <a target=_blank href="emp" class="shortcode_button btn_normal btn_type1">Edit Profile</a>
