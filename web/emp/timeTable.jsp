        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <center>
                    ...
                    <form class="form-inline" enctype="multipart/form-data" name="CV" action="../ttUpload" method="post" onsubmit="return validation()">
                        <div class="form-group">                            
                            <label for="Study Material">Select Time Table for Upload</label>
                            <input type="file" name="study" required="true" accept="application/pdf">
                        </div> 
                        ...
                        <script>
                            function validation() {
                                ...
                                var file1 = formDOMObj.study.value;
