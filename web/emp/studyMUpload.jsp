        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <center>
                    ...
                    <form class="form-inline" enctype="multipart/form-data" name="CV" action="../studyMatUpload" method="post" onsubmit="return validation()">
                        <div class="form-group">                            
                            <label for="Study Material">Select Study material for Upload</label>
